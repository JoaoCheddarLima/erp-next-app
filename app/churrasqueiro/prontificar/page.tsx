    ...
    return (
        <main className="flex min-h-screen flex-col items-center  font-mono p-5">
            ...
            <div className='w-full p-5 flex flex-col gap-4 items-center'>
                <form className="flex flex-col gap-5 w-1/2 text-[1rem]">
            ...
            <div className='w-full p-5'>
                <button
                    ...
                    onClick={
                        async () => {
                            const data: ConfirmedChurrasqueiraItemAssarPostRequest = {
                                amount: soldCount,
                                id: itemType
                            }

                            await fetch('/api/churrasqueiro/prontificar', {
                                method: 'POST',
